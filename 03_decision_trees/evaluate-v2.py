    ...
    with open('./temp-' + socket.gethostname() + '_' + timestr + '.txt', 'a+') as f:
        with redirect_stdout(f):  
            ...
            evaluation_grid = {
                ...
                'dt_setting': [2], # 1=vanilla; 2=SDT ------- 'dt_type', 'decision_sparsity', 'function_representation_type'                
                'inet_setting': [1], 
            ...
            for parameter_setting in parameter_grid:
                if parameter_setting['data_generation_filtering'] == False and parameter_setting['shift_distrib'] == False:
                    parameter_grid.remove(parameter_setting)
