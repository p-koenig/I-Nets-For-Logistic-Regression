...
class DHDT(tf.Module):
    ...
    def forward(self, X):
        ...
        internal_node_result_complete = tf.sigmoid(self.beta_2 * (X_by_index - split_values_by_index - 0.5))
    ...
    def forward_hard(self, X):
        ...
        internal_node_result_complete = tf.round(tf.sigmoid(X_by_index - split_values_by_index - 0.5))
