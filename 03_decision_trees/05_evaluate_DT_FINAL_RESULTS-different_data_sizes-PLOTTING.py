...
def main(): 
    ...
    timestr = '05_evaluate_DT_FINAL_RESULTS-different_data_sizes-20220509-144336'#filename + '-' + time.strftime("%Y%m%d-%H%M%S.%f")[:-3]
    ...
    with open('./running_evaluations/temp-' + socket.gethostname() + '_' + timestr + '.txt', 'a+') as f:
        with redirect_stdout(f):  
            ...
            evaluation_grid = {
                ...
                'random_evaluation_dataset_size_per_distribution': [500, 1_000, 5_000, 10_000, 20_000, 30_000, 40_000, 50_000, 100_000],
