...
from interpretation_net_evaluate import extend_inet_parameter_setting
...
def plot_evaluation_results(timestr, parameter_grid):
    ...
    for parameter_setting in parameter_grid:
        ...
        print(tabulate(real_world_scores_df_distrib_adjusted_mean_std_VANILLA_extended, headers='keys', tablefmt='psql'))


        print('SDT Results:\n')
        print(tabulate(real_world_scores_df_distrib_adjusted_mean_std_SDT_extended, headers='keys', tablefmt='psql'))
        # In[21]:
