...
class SDT(nn.Module):
    ...
    def to_array(self, config=None):
        from utilitiesDT.utility_functions import largest_indices        
...
class parameterDT():
    ...
    def predict(self, X_data):
        from utilitiesDT.metrics import calculate_function_value_from_vanilla_decision_tree_parameters_wrapper
