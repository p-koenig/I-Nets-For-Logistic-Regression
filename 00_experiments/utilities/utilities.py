...
def evaluate_dhdt(identifier, 
    ...
    if sklearn_params is None:
        sklearn_params_help = {'max_depth': config['dhdt']['depth'],
    ...
    if gen_params is None:
        ...
        if isinstance(dataset_dict['X_train'], pd.DataFrame) or isinstance(dataset_dict['X_train'], pd.Series):
            X_train = dataset_dict['X_train'].values
        else:
