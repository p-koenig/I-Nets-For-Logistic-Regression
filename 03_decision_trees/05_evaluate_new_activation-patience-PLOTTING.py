...
def main(): 
    ...
    timestr = '05_evaluate_new_activation-patience-RUNNING-20220424-231422'#filename + '-' + time.strftime("%Y%m%d-%H%M%S.%f")[:-3]
    ...
    with open('./running_evaluations/temp-' + socket.gethostname() + '_' + timestr + '.txt', 'a+') as f:
        with redirect_stdout(f):  
            ...
            evaluation_grid = {
                ...
                'dt_setting': [1, 3, 10], # 1=vanilla; 2=SDT1; 3=SDT-1  ------- 'dt_type', 'decision_sparsity', 'function_representation_type'                
                'inet_setting': [1], 
