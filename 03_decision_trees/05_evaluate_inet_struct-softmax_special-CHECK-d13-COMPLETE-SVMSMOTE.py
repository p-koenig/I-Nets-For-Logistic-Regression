    ...
    with open('./running_evaluations/temp-' + socket.gethostname() + '_' + timestr + '.txt', 'a+') as f:
        with redirect_stdout(f):  
            ...
            evaluation_grid = {
                ...
                'dt_setting': [3, 2, 13], # 1=vanilla; 2=SDT1; 3=SDT-1  ------- 'dt_type', 'decision_sparsity', 'function_representation_type'                
                'inet_setting': [1], 
                ...
                'resampling_strategy': ['SVMSMOTE'], #'ADASYN', 'SMOTE', 'SVMSMOTE', None
