...
def data_path_LR(config):
    return  'data_LR/nda' + str(config['data']['n_datasets']) + '_nsa' + str(config['data']['n_samples']) + '_nfe' + str(config['data']['n_features']) + '_nin' + str(config['data']['n_informative']) + '_nta' + str(config['data']['n_targets']) + '_bia' + str(config['data']['bias']) + '_eff' + str(config['data']['effective_rank']) + '_tai' + str(config['data']['tail_strength']) + '_noi' + str(config['data']['noise']) + '_shu' + str(config['data']['shuffle']) + '_ran' + str(config['data']['random_state']) 
