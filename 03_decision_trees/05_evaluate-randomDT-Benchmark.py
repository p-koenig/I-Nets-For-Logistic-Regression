    ...
    with open('./running_evaluations/temp-' + socket.gethostname() + '_' + timestr + '.txt', 'a+') as f:
        with redirect_stdout(f):  
            ...
            evaluation_grid = {
                ...
                'dt_setting': [3, 1], # 1=vanilla; 2=SDT1; 3=SDT-1  ------- 'dt_type', 'decision_sparsity', 'function_representation_type'                
                'inet_setting': [1], 
                ...
                'function_generation_type': ['distribution', 'random_decision_tree'],# 'make_classification_distribution', 'make_classification_distribution_trained', 'distribution', 'distribution_trained', 'make_classification', 'make_classification_trained', 'random_decision_tree', 'random_decision_tree_trained'
                ...
                'exclude_linearly_seperable': [True, False],
                ...
                'resampling_strategy': [None], #'SMOTE', None
            ...
            Parallel(n_jobs=5, backend='multiprocessing', verbose=10000)(delayed(run_evaluation)(enumerator, timestr, parameter_setting) for enumerator, parameter_setting in enumerate(parameter_grid))
