...
def data_path_LR(config):
    return  'data_LR/nda' + str(config['data']['n_datasets']) + '_nsa' + str(config['data']['n_samples']) + '_nfe' + str(config['data']['n_features']) + '_nin' + str(config['data']['n_informative']) + '_nta' + str(config['data']['n_targets']) + '_ncc' + str(config['data']['n_clusters_per_class']) + '_sep' + str(config['data']['class_sep']) + '_shu' + str(config['data']['shuffle']) + '_ran' + str(config['data']['random_state']) 
...
def inet_path_LR(config):
    return lambda_path_LR(config) + '/' 'tsi' + str(config['inets']['data_prep']['train_test_val_split']['test_size']) + '_vsi' + str(config['inets']['data_prep']['train_test_val_split']['val_size']) + '_noi' + str(config['inets']['data_prep']['train_noise']) + '_ran' + str(config['inets']['data_prep']['train_test_val_split']['random_state']) + '_shu' + str(config['inets']['data_prep']['train_test_val_split']['shuffle']) + '_str' + str(config['inets']['data_prep']['train_test_val_split']['stratify']) + '_bat' + str(config['inets']['model_fit']['batch_size']) + '_epo' + str(config['inets']['model_fit']['epochs']) + '_shu' +  str(config['inets']['model_fit']['shuffle']) + '_cla' + str(config['inets']['model_fit']['class_weight']) + '_sam' + str(config['inets']['model_fit']['sample_weight']) + '_ini' + str(config['inets']['model_fit']['initial_epoch']) + '_ste' + str(config['inets']['model_fit']['steps_per_epoch']) + '_vst' + str(config['inets']['model_fit']['validation_steps']) + '_vbs' + str(config['inets']['model_fit']['validation_batch_size']) + '_vfr' + str(config['inets']['model_fit']['validation_freq'])
